...
class SynthesizerTrn(nn.Module):
    ...
    def _build_g_2(self, spk_emb, reference_emb):
        """
        DEPRECATED: This method used pre-computed speaker embeddings which have been removed.
        Use _build_g instead.
        """
        raise NotImplementedError("_build_g_2 has been removed. Use _build_g instead.")
    ...
    def _build_g_3(self, sid, tid, lid, reference_emb):
        ...
        speaker ID, tone ID, language ID, and reference embeddings.
